...
class TestRegisterTeacher:
    ...
    async def test_create_user_successfully(
        ...
        assert user.email == valid_create_teacher_request.email
    ...
    async def test_contact_limit_session_constraint_catches_bypassed_precheck(
        self,
        field,
        existing_kwargs,
        duplicate_value,
        ...
        setattr(valid_create_teacher_request, field, duplicate_value)
