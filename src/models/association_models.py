...
#     status: Mapped[StudentSubjectStatus] = mapped_column(
#         SQLEnum(StudentSubjectStatus),
#         nullable=False,
#         default=StudentSubjectStatus.studying,
#     )
...
#     __table_args__ = (
#         UniqueConstraint(
#             "student_id", "subject_id", "status", name="uix_student_subject"
#         ),
#     )
...
#     status: Mapped[StudentGroupStatus] = mapped_column(
#         SQLEnum(StudentGroupStatus), nullable=False, default=StudentGroupStatus.studying
#     )
...
#     status: Mapped[TeacherSubjectStatus] = mapped_column(
#         SQLEnum(TeacherSubjectStatus),
#         nullable=False,
#         default=TeacherSubjectStatus.teaching,
#     )
...
#     __table_args__ = (
#         UniqueConstraint(
#             "teacher_id", "subject_id", "status", name="uix_teacher_subject"
#         ),
#     )
