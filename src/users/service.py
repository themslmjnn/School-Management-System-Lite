...
class UserServiceAdmin:
    ...
    async def create_user(
        db: AsyncSession, create_request: CreateUserAdmin
    ) -> User:
        ...
        if create_request.role == UserRole.STUDENT and create_request.date_of_birth is None:
            logger.warning(
        ...
        try:
            ...
            UserRepositoryBase.add_entity(db, new_user_login_lockout)
