...
def update_teacher_subject(
    ...
    return TeacherService.update_teacher_subject(db, user, assignment_id, teacher_subject_update_info_request)
...
def update_teacher_group(
    ...
    return TeacherService.update_teacher_group(db, user, assignment_id, teacher_group_update_info_request)
