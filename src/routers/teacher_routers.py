...
def fire_teacher(db: db_dependency, user: user_dependency, teacher_id: path_param_ge1):
...
def withdraw_teacher_subject(db: db_dependency, user: user_dependency, teacher_subject_id: path_param_ge1):
...
def update_teacher_subject(db: db_dependency, user: user_dependency, teacher_subject_id: path_param_ge1, teacher_subject_update_info_request: TeacherSubjectUpdateInfoAdmin):
...
def withdraw_teacher_group(db: db_dependency, user: user_dependency, teacher_group_id: path_param_ge1):
...
def update_teacher_group(db: db_dependency, user: user_dependency, teacher_group_id: path_param_ge1, teacher_group_update_info_request: TeacherGroupUpdateInfoAdmin):
