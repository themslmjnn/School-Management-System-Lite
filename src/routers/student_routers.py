...
from src.schemas.student_schemas import (
    ...
    StudentResponsePublic,
    StudentUpdateInfoAdmin,
    StudentUpdateInfoResponseAdmin,
)
from src.schemas.student_schemas import (
    StudentSubjectCreateAdmin,
    StudentSubjectResponseAdmin,
    StudentSubjectUpdateInfoAdmin,
)
from src.schemas.student_schemas import (
    StudentGroupCreateAdmin,
    StudentGroupUpdateInfoAdmin,
    StudentGroupResponseAdmin,
)
...
@router.post(
    "/students",
    response_model=StudentResponseAdmin,
    status_code=status.HTTP_201_CREATED,
)
def register_student(
    db: db_dependency, user: user_dependency, student_request: StudentCreateAdmin
):
...
@router.get(
    "/students",
    response_model=list[Union[StudentResponseAdmin, StudentResponsePublic]],
    status_code=status.HTTP_200_OK,
)
def get_students(db: db_dependency, user: user_dependency):
...
@router.put(
    ...
    response_model=StudentUpdateInfoResponseAdmin,
    status_code=status.HTTP_200_OK,
)
def update_student_info(
    ...
    return StudentService.update_student_info(
        db, user, student_id, student_update_info_request
    )
...
@router.post(
    "/students/subjects",
    response_model=StudentSubjectResponseAdmin,
    status_code=status.HTTP_201_CREATED,
)
...
@router.put(
    "/students/subjects/{enrollment_id}/update",
    response_model=StudentSubjectResponseAdmin,
    status_code=status.HTTP_200_OK,
)
def update_student_subject(
    ...
    return StudentService.update_student_subject(
        db, user, enrollment_id, enrollment_update_info_request
    )
...
@router.get(
    "/students/subjects",
    response_model=list[StudentSubjectResponseAdmin],
    status_code=status.HTTP_200_OK,
)
...
@router.post(
    "/students/groups",
    response_model=StudentGroupResponseAdmin,
    status_code=status.HTTP_201_CREATED,
)
...
@router.put(
    "/students/groups/{enrollment_id}/update",
    response_model=StudentGroupResponseAdmin,
    status_code=status.HTTP_200_OK,
)
def update_student_group(
    ...
    return StudentService.update_student_group(
        db, user, enrollment_id, student_group_update_info_request
    )
...
@router.get(
    "/students/groups",
    response_model=list[StudentGroupResponseAdmin],
    status_code=status.HTTP_200_OK,
)
