...
class TeacherRepository:
    ...
    def get_teacher_by_id(db: Session, teacher_id):
        query = select(Teacher).filter(Teacher.id == teacher_id)
    ...
    def get_teacher_subject_by_id(db: Session, assignment_id):
        query = select(TeacherSubject).filter(TeacherSubject.id == assignment_id)
    ...
    def get_teacher_group_by_id(db: Session, assignment_id):
        query = select(TeacherGroup).filter(TeacherGroup.id == assignment_id)
